...
-define(METRICS,
        ...
        [{[block, get], spiral, [],
         ...
         {[bucket, head], spiral, [],
          [{one, bucket_heads}, {count, bucket_heads_total}]},
         ...
         {[bucket, head, time], histogram, [],
          [{mean  , bucket_head_time_mean},
           {median, bucket_head_time_median},
           {95    , bucket_head_time_95},
           {99    , bucket_head_time_99},
           {100   , bucket_head_time_100}]},
         ...
         {[object, put_copy], spiral, [],
          [{one, object_put_copy}, {count, object_put_copy_total}]},
         {[object, head], spiral, [],
         ...
         {[object, put_copy, time], histogram, [],
          [{mean  , object_put_copy_time_mean},
           {median, object_put_copy_time_median},
           {95    , object_put_copy_time_95},
           {99    , object_put_copy_time_99},
           {100   , object_put_copy_time_100}]},
