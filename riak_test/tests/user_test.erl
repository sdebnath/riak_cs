...
update_user_test(AdminConfig, Node, ContentType, Users) ->
    ...
    UserResult1 = parse_user_record(
                    rtcs:get_user(UserConfig, Port, UserResource, ContentType),
                    ContentType),
    %% Fetch the user record using the admin credentials
    UserResult2 = parse_user_record(
                    rtcs:get_user(AdminConfig, Port, AdminResource, ContentType),
                    ContentType),
    ...
    ErrorResult = parse_error_code(
                    catch rtcs:update_user(UserConfig,
                                           Port,
                                           Resource,
                                           ContentType,
                                           InvalidUpdateDoc)),
    ...
    ErrorResult2 = parse_error_code(
                    catch rtcs:update_user(BadUserConfig,
                                           Port,
                                           Resource,
                                           ContentType,
                                           UpdateDoc2)),
    ...
    UserResult5 = parse_error_code(
                    catch rtcs:get_user(UserConfig, Port,
    ...
    UserResult7 = parse_user_record(
                    rtcs:get_user(UserConfig2, Port, UserResource, ContentType),
                    ContentType),
    %% Fetch the user record using the admin credentials
